...
namespace TourGuide.Controllers
{
    ...
    public class PhotosController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchString)
        {
            ...
            {
                photos = photos.Where(s => s.Place.PlaceName.Contains(searchString));
            }
            return View(await photos.Include(p => p.Place).AsNoTracking().ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("PhotoID,FileUpload,PlaceID")] Photo photo)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var uploadsRootFolder = Path.Combine(_environment.WebRootPath, "places");
            ...
            ViewData["PlaceID"] = new SelectList(_context.Places, "PlaceID", "PlaceName", photo.PlaceID);
            return View(photo);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["PlaceID"] = new SelectList(_context.Places, "PlaceID", "Description", photo.PlaceID);
            return View(photo);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PhotoID,ExtName,PlaceID")] Photo photo)
        {
            if (id != photo.PhotoID)
            {
                return NotFound();
